...
num_strings = 30 # number of Pauli strings to generate
nqubits = 7 # number of qubits in ansatz
layers = 2 # number of layers in ansatz - assumed to be 12 by default in RIDA.py
...
for i in range(num_strings):
    ...
    measurements = [i for i in range(nqubits)]
    pstring = 'ZZZZ'
...
if save_results:
    file_path = 'real_' + str(nqubits)+'qbt_params'
